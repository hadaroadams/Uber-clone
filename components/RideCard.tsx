...
const RideCard = ({ ride }: { ride: Ride }) => {
  ...
  return (
    <View className="flex flex-row items-center justify-center bg-white rounded shadow-sm shadow-neutral-300 mb-3">
      <View className="flex flex-col items-center justify-center p-3">
        ...
        <View className="flex flex-col w-full mt-5 bg-general-500 p-1 rounded-lg">
